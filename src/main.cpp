...
int main(int argc, char *argv[])
{
	...
	try {
		...
		ColorRenderTarget colorRenderTarget(renderTargetFormat, width, height, 1, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT | VK_IMAGE_USAGE_TRANSFER_SRC_BIT);
		...
		renderpassCreateInfo.pSubpasses = &renderSceneSubpass;
