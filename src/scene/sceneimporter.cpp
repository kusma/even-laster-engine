...
Material *SceneImporter::convertMaterial(aiMaterial *material)
{
	return new Material(); // TODO: load actual material and stuff :/
}

void SceneImporter::convertMaterials()
{
	materials.resize(source->mNumMaterials);
